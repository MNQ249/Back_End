...
--     configuration, no userEntity is granted access to this role by default.
...
-- Example for adding a SQL authentication userEntity to the SqlJDBCXAUser role.
-- exec sp_addrolemember [SqlJDBCXAUser], 'MySQLUser'

-- Example for adding a windows domain userEntity to the SqlJDBCXAUser role.
